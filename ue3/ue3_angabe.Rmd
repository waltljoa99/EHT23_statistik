...
par(mfrow = c(1,3))
hist(birthwt$bwt[birthwt$ethnic == 'white'], main = "ehnic 1 (white)")
hist(birthwt$bwt[birthwt$ethnic == 'black'], main = "ehnic 2 (black)")
hist(birthwt$bwt[birthwt$ethnic == 'other'], main = "ehnic 3 (other)")
...
for(activity in unique_activities) {
  ...
  hist(activity_data, probability = TRUE,
       main = paste("Histogramm f.", activity),
       xlab = "Gewichtsabnahme (kg)",
       col = "gray", border = "black",
       ylim = c(0, 0.15))
...
leveneTest(wloss ~ diet * activity, data = weightloss)
...
```{r}
# Boxplot (diets)
boxplot(weightloss$wloss ~ weightloss$diet,
        main = "Gewichtsabnahme in Abhängigkeit der Diät",
        xlab = "Diät",
        ylab = "Gewichtsabnahme (in kg)")
