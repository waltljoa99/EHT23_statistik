...
# DBSCAN Clustering
dbscan_pca <- dbscan(, eps = 5, MinPts = 50)
...
set.seed(123)
kmeans_result <- kmeans(heart_disease_patients_scaled, centers=3)

# Evaluate the performance
silhouette_score <- cluster.stats(dist(heart_disease_patients_scaled), kmeans_result$cluster)$silhouette.avg
print(paste("Silhouette Score: ", silhouette_score))

# Interpret the clusters
print(kmeans_result$centers)

create_scatter_plot_pca(heart_disease_patients, kmeans_result$cluster)
