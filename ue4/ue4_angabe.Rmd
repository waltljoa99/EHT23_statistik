...
Anhand der Histogramme lässt sich PC2 nicht als Trennungskriterium verwenden, da die Gruppen sich überlappen.
Allerdings lässt ich die "overt" Gruppe bei PC1 Scores gut von den anderen Gruppen abgrenzen.
...
allerdings sind die PC1 Scores keineswegs normalverteilt (p-Wert nahezu 0).
...
Selbst nach der Transformation der Daten sind die PC Scores noch immer nicht normalverteilt. Die Diskriminanzanalyse wird dennoch durchgeführt, da sie robust gegenüber Verletzungen der Normalverteilung ist.
